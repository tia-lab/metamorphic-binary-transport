...
fn arrow_record_batch(
    ...
    let columns: Vec<ArrowArrayRef> = vec![
        ...
        metamorphic_binary_transport_adapter_arrow::u16_array(batch.tenant_ordinal)?,
        metamorphic_binary_transport_adapter_arrow::u16_array(batch.entity_ordinal)?,
        metamorphic_binary_transport_adapter_arrow::i64_array(batch.close_ms)?,
        metamorphic_binary_transport_adapter_arrow::u16_array(batch.status_ordinal)?,
        metamorphic_binary_transport_adapter_arrow::optional_u16_array(
            batch.optional_status_ordinal,
        )?,
        metamorphic_binary_transport_adapter_arrow::u64_array(batch.venues_mask)?,
        metamorphic_binary_transport_adapter_arrow::i64_array(batch.required_i64)?,
        metamorphic_binary_transport_adapter_arrow::optional_i64_array(batch.optional_i64)?,
        metamorphic_binary_transport_adapter_arrow::i32_array(batch.required_i32)?,
        metamorphic_binary_transport_adapter_arrow::optional_i32_array(batch.optional_i32)?,
        metamorphic_binary_transport_adapter_arrow::u32_array(batch.required_u32)?,
        metamorphic_binary_transport_adapter_arrow::optional_u32_array(batch.optional_u32)?,
        metamorphic_binary_transport_adapter_arrow::f64_array(batch.required_f64)?,
        metamorphic_binary_transport_adapter_arrow::optional_f64_array(batch.optional_f64)?,
        metamorphic_binary_transport_adapter_arrow::f32_array(batch.required_f32)?,
        metamorphic_binary_transport_adapter_arrow::optional_f32_array(batch.optional_f32)?,
        metamorphic_binary_transport_adapter_arrow::bool_array(batch.required_bool)?,
        metamorphic_binary_transport_adapter_arrow::bool_array(batch.optional_bool)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.required_text)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.optional_text)?,
        metamorphic_binary_transport_adapter_arrow::binary_array(batch.required_bytes)?,
        metamorphic_binary_transport_adapter_arrow::binary_array(batch.optional_bytes)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.uuid_text)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.jsonb_text)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.timestamptz_text)?,
        metamorphic_binary_transport_adapter_arrow::utf8_array(batch.numeric_text)?,
        metamorphic_binary_transport_adapter_arrow::i64_list_array(batch.required_i64_array)?,
        metamorphic_binary_transport_adapter_arrow::optional_i64_list_array(
            batch.nullable_i64_array,
        )?,
        metamorphic_binary_transport_adapter_arrow::i32_list_array(batch.required_i32_array)?,
        metamorphic_binary_transport_adapter_arrow::optional_i32_list_array(
            batch.nullable_i32_array,
        )?,
        metamorphic_binary_transport_adapter_arrow::u32_list_array(batch.required_u32_array)?,
        metamorphic_binary_transport_adapter_arrow::optional_u32_list_array(
            batch.nullable_u32_array,
        )?,
        metamorphic_binary_transport_adapter_arrow::f64_list_array(batch.required_f64_array)?,
        metamorphic_binary_transport_adapter_arrow::optional_f64_list_array(
            batch.nullable_f64_array,
        )?,
        metamorphic_binary_transport_adapter_arrow::f32_list_array(batch.required_f32_array)?,
        metamorphic_binary_transport_adapter_arrow::optional_f32_list_array(
