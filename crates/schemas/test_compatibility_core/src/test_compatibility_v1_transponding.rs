...
pub(crate) struct TestCompatibilityV1ColumnBatch {
    ...
    pub(crate) sites_mask: U64Column,
...
impl TestCompatibilityV1ColumnBatch {
    pub(crate) fn byte_len(&self) -> usize {
        ...
        len = len.saturating_add(self.sites_mask.byte_len());
...
impl TestCompatibilityV1 {
    pub(crate) fn transpond_archived(
        ...
        let mut sites_mask = U64Column::new(row_count);
        ...
        for row in archived.rows.iter() {
            ...
            sites_mask.push_required(row.sites_mask.to_native());
