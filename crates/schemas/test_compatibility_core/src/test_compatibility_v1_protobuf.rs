...
fn encoded_len_row(
    ...
    len = output::checked_len_add(
        len,
        proto::encoded_len_int64(4, row.recorded_at_ms.to_native()),
        max_response_bytes,
    )?;
    len = output::checked_len_add(
        len,
    ...
    if row.sites_mask.to_native() & (1_u64 << 0) != 0 {
        len = output::checked_len_add(
            len,
            output::encoded_len_string(7, "site_a"),
            max_response_bytes,
        )?;
    }
    if row.sites_mask.to_native() & (1_u64 << 1) != 0 {
        len = output::checked_len_add(
            len,
            output::encoded_len_string(7, "site_b"),
            max_response_bytes,
        )?;
    }
    if row.sites_mask.to_native() & (1_u64 << 2) != 0 {
        len = output::checked_len_add(
            len,
            output::encoded_len_string(7, "site_c"),
            max_response_bytes,
        )?;
    }
    len = output::checked_len_add(
...
fn write_protobuf_row(
    ...
    writer.int64(4, row.recorded_at_ms.to_native())?;
    ...
    if row.sites_mask.to_native() & (1_u64 << 0) != 0 {
        writer.string(7, "site_a")?;
    }
    if row.sites_mask.to_native() & (1_u64 << 1) != 0 {
        writer.string(7, "site_b")?;
    }
    if row.sites_mask.to_native() & (1_u64 << 2) != 0 {
        writer.string(7, "site_c")?;
    }
